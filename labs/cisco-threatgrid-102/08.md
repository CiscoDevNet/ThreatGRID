...
>##  	&#9881; Exercise:
> 
> Using everything you have learned so far, the tables and information available in this course, and the Threat Grid help documentation in the product interface,  write a script that will output the domains, urls, and IP addresses contacted by samples your organization uploaded for analysis in the last 24 hours.
