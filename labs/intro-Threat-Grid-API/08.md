...
<!-- Github: (https://github.com/CiscoDevNet/ThreatGRID/blob/master/labs/cisco-threatgrid-102/assets/images/simplest_fetcher.png) -->
> <!-- LL: (/posts/files/cisco-threatgrid-102/assets/images/simplest_fetcher.png) -->
> 
